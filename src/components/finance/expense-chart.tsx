...
export function ExpenseChart({ data }: ExpenseChartProps) {
  ...
  const chartData = [
    { name: "Rent", value: data.rent, color: "#ef4444" },
    { name: "Utilities", value: data.utilities, color: "#f59e0b" },
    { name: "Staff Salary", value: data.staff_salary, color: "#3b82f6" },
    { name: "Equipment", value: data.equipment, color: "#10b981" },
    { name: "Marketing", value: data.marketing, color: "#8b5cf6" },
    { name: "Maintenance", value: data.maintenance, color: "#ec4899" },
