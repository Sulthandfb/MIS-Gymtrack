  ...
  useEffect(() => {
    const loadTrainerDetailData = async () => {
      try {
        setLoading(true)
        if (!trainerId) {
          setError("Trainer ID tidak ditemukan")
          return
        }
        ...
        <div className="p-4 lg:p-6 flex-1 overflow-y-auto min-h-0">
          <div className="grid grid-cols-12 gap-4 lg:gap-6">
            ...
            <div className="col-span-12 lg:col-span-4 space-y-4 lg:space-y-6">
              {/* Profile Card */}
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm text-center">
              ...
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
                <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Contact</h3>
            ...
            <div className="col-span-12 lg:col-span-8 space-y-4 lg:space-y-6">
              ...
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                  <div>
                    <h3 className="text-base lg:text-lg font-semibold text-gray-900">Training Activity</h3>
                    <p className="text-xs lg:text-sm text-gray-500">Aktivitas training dalam {dateRange} hari terakhir</p>
                  </div>
                  <div className="flex gap-2">
                    <Button
                ...
                <div className="flex flex-wrap gap-3 lg:gap-4 text-xs lg:text-sm mb-4">
              ...
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                  <div>
                    <h3 className="text-base lg:text-lg font-semibold text-gray-900">Jadwal & Member List</h3>
                    <p className="text-xs lg:text-sm text-gray-500">Jadwal kelas dan daftar member aktif</p>
                  </div>
                  <div className="flex gap-2">
                    <Button
                      ...
                      currentSchedule.map((class_item) => (
                        <div key={class_item.id} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-3">
                            <h4 className="font-semibold text-gray-900 text-sm lg:text-base">{class_item.name}</h4>
