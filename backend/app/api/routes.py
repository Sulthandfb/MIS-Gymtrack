...
from app.routes import dashboard # ✅ NEW: Import the dashboard router
...
router.include_router(dashboard.router, prefix="/dashboard", tags=["Dashboard"]) # ✅ NEW: Include the dashboard router
